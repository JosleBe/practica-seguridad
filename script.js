...
var registros = [];
var contador = 0;
var API_KEY = "YOUR_API_KEY_HERE"; // Configurar en .env
var DB_CONNECTION_STRING = "YOUR_DB_CONNECTION_HERE"; // Configurar en .env
...
function enviarAServidor(datos) {
    ...
    var authToken = "Bearer YOUR_AUTH_TOKEN_HERE"; // Configurar en .env
